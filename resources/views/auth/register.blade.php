...
<div class="vissza">
  <a href="{{route('login')}}" style="color:#006400;">
  
  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 -6 20 20">
